...
DATA_DIR = r"c:\Users\birge\OneDrive - NTNU\Skole\Master\VSCode\testdata\lekkasjetest_1_finger\0.04bar"
...
plt.tight_layout()
plt.savefig(os.path.join(DATA_DIR, "lekkasje_0.04bar_1finger.png"), dpi=150)
