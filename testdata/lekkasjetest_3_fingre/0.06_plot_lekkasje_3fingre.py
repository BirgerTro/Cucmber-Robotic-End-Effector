...
DATA_DIR = r"c:\Users\birge\OneDrive - NTNU\Skole\Master\VSCode\testdata\lekkasjetest_3_fingre"
...
ax.set_ylim(y_lo - 4*margin, y_hi + margin)
ax.set_xlabel(f"Time after reaching {TARGET_PRESSURE} bar [s]")
ax.set_ylabel("Pressure [bar]")
ax.set_title(f"Leakage during hold phase at {TARGET_PRESSURE} bar – 3 fingers")
ax.legend()
ax.grid(True, alpha=0.3)
plt.tight_layout()
plt.savefig(os.path.join(DATA_DIR, "lekkasje_0.06bar_3fingre.png"), dpi=150)
...
for s in stats:
    ...
    print(f"{name:<10} {bp:>14.5f} {ep:>12.5f} {drop:>12.5f} {rate:>14.2e} {rel:>12.4f}")
